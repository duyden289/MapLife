...
+(MServerURI *)sharedInstance
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        NSString *pathServer = [[NSBundle mainBundle] pathForResource:CONFIG_SERVER ofType:@"plist"];
        serverURI.serverDictionary = [[NSDictionary alloc] initWithContentsOfFile:pathServer];
...
{
    NSString *appiWeatherServer = [self.serverDictionary objectForKey:MWEARTHER_SERVER_KEY];
